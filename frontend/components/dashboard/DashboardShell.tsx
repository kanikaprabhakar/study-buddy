    ...
    return (
      <div className="flex flex-col items-center gap-3 py-2 text-center">
        ...
        <button onClick={onConnect}
          className="relative z-10 flex items-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-bold text-white shadow-lg transition-all hover:scale-105"
          style={{ background: "linear-gradient(135deg,#CB438B,#BF3556)" }}>
  ...
  return (
    <div>
      ...
      <button onClick={onDisconnect}
        className="relative z-10 mt-4 text-[11px] font-bold text-fg-secondary opacity-50 hover:opacity-100 transition-opacity"
        style={{ color: "#BF3556" }}>
        Disconnect Calendar
      </button>
    </div>
